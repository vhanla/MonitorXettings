...
var
  NvAPI_GetDVCInfo: function(hNvDisplay: NvDisplayHandle; OutPutId: NvU32; var info: NV_DISPLAY_DVC_INFO): NvAPI_Status; cdecl;

var
  NvAPI_SetDVCLevel: function(handle: NvU32; OutPutId: NvU32; level: NvU32):NvAPI_Status; cdecl;

var
  NvAPI_GetDVCInfoEx: function(hNvDisplay: NvDisplayHandle; OutPutId: NvU32; var info: NV_DISPLAY_DVC_INFO): NvAPI_Status; cdecl;
...
const
  NvAPIFunctions: array[0..92] of TNvAPIFuncRec = (
    ...
    //added 2021 for vibrance control
    (ID: $4085DE45; Func: @@NvAPI_GetDVCInfo),
    (ID: $172409B4; Func: @@NvAPI_SetDVCLevel),
    (ID: $0E46002D; Func: @@NvAPI_GetDVCInfoEx),
